...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $listingType = $_POST['listing_type'] ?? 'sell'; // Naujas laukas
    ...
    if (!in_array($listingType, ['sell', 'buy'])) {
        $listingType = 'sell';
    }
  ...
  <div class="page">
    <section class="hero">
        <div style="max-width: 800px; margin: 0 auto;">
            ...
            <p>Įkelkite daiktą pardavimui arba sukurkite paieškos skelbimą.</p>
        </div>
    </section>
    ...
    <div class="card">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="type-selector">
              ...
              <label class="radio-option">
                  <input type="radio" name="listing_type" value="buy" <?php echo (isset($_POST['listing_type']) && $_POST['listing_type'] === 'buy') ? 'checked' : ''; ?>>
                  <div class="radio-tile">
                      <div class="icon">🔍</div>
          ...
          <label>
            ...
            <input name="title" value="<?php echo htmlspecialchars($_POST['title'] ?? ''); ?>" required placeholder="Pvz.: Parduodu gliukomatį arba Ieškau pompos...">
          </label>
          
          <label>
            <span>Aprašymas</span>
            <textarea name="description" style="min-height:160px;" required placeholder="Išsamiai aprašykite prekę, jos būklę..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
          </label>
          
          <div class="form-row">
              <label>
                <span>Kaina / Biudžetas (€)</span>
          ...
          <label>
            <span>Nuotrauka (neprivaloma)</span>
            <input type="file" name="image" accept="image/*" style="padding: 10px;">
          </label>
          
          <div style="display:flex; gap:12px; margin-top: 24px;">
            <button class="btn" type="submit">Pridėti skelbimą</button>

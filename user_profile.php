...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .listing-img { height: 160px; width: 100%; object-fit: cover; background: #f1f5f9; }
                ...
                <?php foreach ($listings as $listing): ?>
                    <div class="listing-card">
                        <?php if (!empty($listing['image'])): ?>
                            <img src="uploads/<?= htmlspecialchars($listing['image']) ?>" class="listing-img" alt="Skelbimas">
                        <?php else: ?>
      ...
      <div>
        ...
        <?php elseif (!$currentUserId): ?>
            <div class="card" style="text-align: center;">
                ...
                <a href="login.php" class="btn-primary" style="text-decoration: none;">Prisijunkite</a>
            </div>
        <?php else: ?>

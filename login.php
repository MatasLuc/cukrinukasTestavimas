    ...
    <div class="auth-container">
        <div class="auth-info">
            ...
            <ul class="feature-list">
                <li class="feature-item"><div class="feature-icon">✓</div><span>Greitas užsakymų valdymas</span></li>
                <li class="feature-item"><div class="feature-icon">✓</div><span>Išsaugoti receptai ir prekės</span></li>
                <li class="feature-item"><div class="feature-icon">✓</div><span>Personalizuoti pasiūlymai</span></li>
            </ul>
        </div>

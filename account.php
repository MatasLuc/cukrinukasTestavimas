          ...
          <div class="card">
            ...
            <div class="account-row">
                ...
                <?php if (!empty($user['facebook_id'])): ?>
                    <form method="post" style="margin:0;">
                        <?php echo csrfField(); ?>
                        <input type="hidden" name="unlink_facebook" value="1">
                        <button type="submit" class="btn-unlink" onclick="return confirm('Ar tikrai norite atsieti Facebook paskyrą?')">Atsieti</button>
                    </form>
                <?php else: ?>
                    <button type="button" class="btn-link-fb" onclick="linkFacebook()">Susieti su Facebook</button>
                <?php endif; ?>
            </div>
